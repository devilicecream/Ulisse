...
{       
/* VARIABILI PRIVATE */
private SurfaceView mSurfaceView; //serve x usare surfaceHolder
private SurfaceHolder mSurfaceHolder; //terreno x l'attivazione della fotocamera
private Camera mCamera;
private boolean mPreviewRunning;
       
/** Called when the activity is first created. */
@Override
public void onCreate(Bundle savedInstanceState) //Activity, quando crea la finestra la chiama 
{
        ...
        ImageButton buttonPicture = (ImageButton) findViewById(R.id.camera_surface_button);
                buttonPicture.setOnClickListener(new OnClickListener()  //Callback
                {
                        public void onClick(View v) 
                        {
                                mCamera.takePicture(null, null, jpegCallback); //Acquisisce la foto
                        }
                } );
